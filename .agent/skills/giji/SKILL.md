...
1. `pages/[英語名]/[YYYYMMDD]/index.html` にスライドHTMLをコピー（英語名はクライアント名のローマ字、日付は打ち合わせ日）
2. git add → commit → push
3. GitHub PagesのURL: `https://linemailgift.github.io/agent-workspace/pages/[英語名]/[YYYYMMDD]/`

```bash
mkdir -p pages/[英語名]/[YYYYMMDD]
cp "[スライドHTMLパス]" pages/[英語名]/[YYYYMMDD]/index.html
